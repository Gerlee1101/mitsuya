...
export default function ChainStorePage() {
  const stores = [
    ...
    },
    {
      ...
      features: ["Хүнсний зах дотор", "Зогсоол", "Зөвлөгөө", "Яармагийн төв зам дагуу", "Ресторан"],
    },
    {
      id: 4,
      images: ["/branch-UTs/2c63bfd7-c05b-46fe-b053-8c1f5920dcf2.jpeg",
        "/branch-UTs/52ad5538-729c-4a2d-abc0-dfe34a5d656d.jpeg",
        "/branch-UTs/475e024d-fd50-4176-9fca-4e83afc952a5.jpeg",
      ],
      name: "Урт цагаан салбар",
      address: "Чингэлтэй дүүрэг, 3-р хороо,  Pearl Tower",
      mapLink: "https://maps.app.goo.gl/pjVcpbRkEV9rhtku8",
      phone: "+976 89002315",
      hours: "10:00 - 20:00",
      description: "Урт цагаан төв замын төв буудлаас 5 минут",
      features: ["Зогсоол", "Зөвлөгөө", "Урт цагаан төв зам дагуу", "Ресторан", "Бөмбөгөр худалдааны төвөөс 5мин"],
    },
    {
      id: 5,
      images: [],
